...
### 1.4 iTerm2 with AI Plugin **[OPTIONAL]**
...
- [ ] Verify installation: `claude --version` (note: command is `claude`, not `claude-code`)
...
This template provides a comprehensive checklist for migrating from an Intel Mac to an M1 Mac with a complete development environment.

### How to Use:
1. Copy this template to your own checklist file
2. Fill in the date fields at the top
3. Work through each phase sequentially
4. Check off items as you complete them
5. Add notes about versions, issues, or customizations
6. Update the Completion Summary at the end

### Recommended Order:
- **Phase 1**: Foundation tools (required for everything else)
- **Phase 2**: Development tools
- **Phase 3**: Claude Desktop + Cowork
- **Phase 4**: Clone and configure your projects
- **Phase 5**: Audit M1 setup, then decommission Intel Mac

### Tips:
- All tools should be ARM-native for best performance
- Test each phase before moving to the next
- Keep notes about any compatibility issues
- Back up your Intel Mac before decommissioning
- Rotate API keys and SSH keys for security
